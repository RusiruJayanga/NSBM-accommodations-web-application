        ...
        <div class="container">
          <div class="signup-content">
            <div class="signup-form">
              <h2 class="form-title" style="text-align: center;">Land Lord Register</h2>
              <form method="post" class="register-form" action="Land_signup_process.php" id="register-form">
            ...
            <div class="signup-image">
              ...
              <a href="Land_login.php" class="signup-image-link">I am already member</a>
            </div>
          </div>
        </div>
      </section>
