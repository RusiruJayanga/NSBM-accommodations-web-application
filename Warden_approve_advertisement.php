...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>Warden Advertisement</title>
...
try {
    ...
    $stmt = $conn->query("SELECT * FROM advertisement_table1");
...
?>
            <tbody>
                <tr>
                    ...
                    <td>
                        <form action="Warden_approvalItem.php" method="post">
                            <input type="hidden" name="appitem_id" value="<?php echo $row['id']; ?>">
                            <button style="width: 100%;" type="submit" class="btn btn-primary">Approve</button>
                        </form>
                        <form action="Warden_deleteItem1.php" method="post">
